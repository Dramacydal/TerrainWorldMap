...
local function RefreshOverlay()
    ...
    -- opt-in only. Twm_CityMapIDs (Data_<Flavor>/mapdata_continents.lua,
    -- generated by scripts/gen_mapareas.js from mapdata_zones.lua's
    -- Twm_CapitalAreaIDs) since Blizzard's map hierarchy gives no
    ...
    if(continent) then
        -- Blizzard's "explored area" pin (and similar "show unexplored
        -- areas" options in other map addons, which force it to paint even
