...
YATLAS_HELP_TEXT = {
    "Yatlas отображает карту мира на основе миникарты (довольно высокая "..
        "детализация).\n\n"..
...
YATLAS_TOOLTIP_LEFTCLICK_OPEN = "|cff40ff40Левый клик|r: открыть Yatlas";
...
YATLAS_MENU_OPEN = "Открыть Yatlas";
...
YATLAS_WORLDMAP_OVERLAY_ON = "Yatlas: наложение на карту мира ВКЛ";
YATLAS_WORLDMAP_OVERLAY_OFF = "Yatlas: наложение на карту мира ВЫКЛ";
YATLAS_DEBUG_TILES_ON = "Yatlas: отладочные метки тайлов ВКЛ";
YATLAS_DEBUG_TILES_OFF = "Yatlas: отладочные метки тайлов ВЫКЛ";

YATLAS_OPTIONS_TITLE = "Настройки Yatlas";
...
BINDING_NAME_YATLAS_TOGGLE = "Открыть/закрыть окно Yatlas";
